...
export const TWO_DIMENSION_GAME_CARD_LIST: GameCard[] = [
    {   title: "Chat",
        ...
        highScoreSolo: ["1:21 Paul", "1:34 AAA", "1:45 OOO"],
        highScore1v1: ["0:58 Ko", "1:13 frew1", "1:21 frew2"],
    },
    ...
    {   title: "test",
        ...
        highScoreSolo: ["3:30 blabla", "4:31 user", "4:55 name"],
        highScore1v1: ["2:08 nick", "2:33 te", "2:48 nice"],
    },
